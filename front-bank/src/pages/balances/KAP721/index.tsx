...
const Balance721 = () => {
  ...
  const handleGetBalance = async () => {
    const data = await sdk.getBalance721(tokenAddress)
    setBalance(data.toString())
  }

  return (
    <>
      <h1>🖼️ Balance KAP721</h1>
      <AuthenticationsSection />
      <div className='divider' />

      {isLoggedIn && (
        <>
          <h2>Get Balance KAP721</h2>
          <Title>sdk.getBalance721()</Title>
          ...
          <div className='divider' />
          <h2>Transfer Balance KAP721</h2>
          <Title>sdk.transfer721()</Title>
          <div className='flex flex-direction-col'>
            <ItemWrapper className='ibm-plex-mono flex flex-direction-col' showData={!!status}>
              ...
              <input onChange={(e) => setTokenId(e.target.value)} placeholder='Token Address' value={tokenId} />
